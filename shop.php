...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!--Page Title-->
        <section class="page-title" style="background-image:url(images/bg/bnr1.jpg)">
            ...
            <div class="auto-container">
                ...
                <div class="shop-upper-box clearfix">
                    <div class="orderby">
                        <select name="orderby" class="sortby-select select2-offscreen"
                            ...
                            <option value="all" <?php echo ($currentCategory === 'all') ? 'selected' : ''; ?>>All
                                Categories</option>
                            <?php foreach ($categories as $key => $value): ?>
                            <option value="<?php echo $key; ?>"
                                <?php echo ($currentCategory === $key) ? 'selected' : ''; ?>><?php echo $value; ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="search-widget">
                        <form method="post" action="contact.html">
                            <div class="form-group">
                                <input type="search" class="search-product" name="search-field" value=""
                ...
                <div class="category-wrapper">
                    <div class="shop-items row clearfix">
                        <?php echo displayProducts($currentCategory, $products); ?>
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <div class="outer-box clearfix">
                                        <figure class="image"><a href="https://via.placeholder.com/150x150"
                                                class="lightbox-image" data-fancybox='instagram'><img
                                                    src="https://via.placeholder.com/150x150" alt=""></a></figure>
