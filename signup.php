...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        $query = "INSERT INTO customers (first_name, second_name, user_email,phone, user_pasword) VALUES (?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($query);
        $stmt->bind_param('sssss', $first_name, $second_name, $user_email,$phone, $hashed_password);
        $stmt->execute();
...
<head>
    <meta charset="utf-8">
    <title>Bellaria - a Delicious Cakes and Bakery HTML Template | My Account</title>
                ...
                <div class="login-form">
                    ...
                    <?php } ?> <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="user_pasword" placeholder="" required>
                        </div>

                        <div class="form-group">

                            <input class="theme-btn" type="submit" name="submit-form" value="Sign Up">
                        </div>
