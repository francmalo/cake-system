...
include_once("http://246b-212-22-181-26.ngrok.io/orders/vendor/autoload.php");

use Symfony\Component\Dotenv\Dotenv;
// $dotenv = new Dotenv();
// $dotenv->load('C:/xampp/htdocs/orders/.env');
/**
 * Class Mpesa
...
class Mpesa
{
    ...
    */
    public static function env($env_param){
        ...
        // $dotenv->load('../.env');
        $dotenv->load('http://246b-212-22-181-26.ngrok.io/orders/.env');
    ...
    public static function generateLiveToken(){
        ...
        try {
            $consumer_key = "ilYBFyLm7Aj7Ubb0ql7enEkrq7rAQd5y"; // env("MPESA_CONSUMER_KEY");
            $consumer_secret = "i6gcyu21XCDGPMQb"; // env("MPESA_CONSUMER_SECRET");
        } catch (\Throwable $th) {
            $consumer_key = "ilYBFyLm7Aj7Ubb0ql7enEkrq7rAQd5y"; // self::env("MPESA_CONSUMER_KEY");
            $consumer_secret = "i6gcyu21XCDGPMQb"; // self::env("MPESA_CONSUMER_SECRET");
        }
    ...
    public static function generateSandBoxToken(){
        ...
        try {
            $consumer_key = "pDE7qbDXh5UHGbcpbwVpi28tJzMKME3T"; // env("MPESA_CONSUMER_KEY");
            $consumer_secret = "Ri66AWgJsqxirkAn"; // env("MPESA_CONSUMER_SECRET");
        } catch (\Throwable $th) {
            $consumer_key = "pDE7qbDXh5UHGbcpbwVpi28tJzMKME3T"; // self::env("MPESA_CONSUMER_KEY");
            $consumer_secret = "Ri66AWgJsqxirkAn"; // self::env("MPESA_CONSUMER_SECRET");
        }
    ...
    public static function reversal($CommandID, $Initiator, $SecurityCredential, $TransactionID, $Amount, $ReceiverParty, $RecieverIdentifierType, $ResultURL, $QueueTimeOutURL, $Remarks, $Occasion){
        ...
        try {
            $environment = "sadbox"; // env("MPESA_ENV");
        } catch (\Throwable $th) {
            $environment = "sadbox"; // self::env("MPESA_ENV");
        }
